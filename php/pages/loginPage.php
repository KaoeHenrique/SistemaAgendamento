...
if (isset($_POST['BtnEntrar'])) {
  ...
  $stmt2 = $pdo->prepare("SELECT email_cli, senha_cliente, nome_cli FROM cliente WHERE email_cli = :email AND senha_cliente = :senha");
...
if (isset($_POST['btnSalvar'])) {
  ...
  $sql = "INSERT INTO cliente (nome_cli, tel_cli, end_cli, dt_nasc_cli, email_cli, senha_cliente) VALUES (:n, :t, :en, :d, :e, :s);";
